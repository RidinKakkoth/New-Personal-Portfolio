  ...
  return (
    <div className="w-full h-screen bg-[#0a192f]">
      ...
      <div className="max-w-[1000px]  mx-auto px-8 flex flex-col justify-center h-full " >
        ...
        <p className="text-[#8892b0] py-4  max-w-[700px]">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maiores, consequuntur officiis. Itaque, fugiat quasi repellat odio voluptatum nemo quae voluptas sequi, commodi ullam quaerat nostrum incidunt possimus exercitationem debitis natus.</p>
        <div>
